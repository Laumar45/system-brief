...
| 11 | Project Structure | 🟢 Medium — helps orientation | Optional for single-file/spike projects | Directory tree with per-file purpose comments; **Naming Dictionary column/subsection when the project has 3+ reusable components or is an evolution brief** (see below) |
